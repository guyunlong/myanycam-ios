...
//Track Colors
#define kDefaultTrackOnColor    [UIColor colorWithRed:26/255.0 green: 27/255.0 blue: 29/255.0 alpha: 1.0]
#define kDefaultTrackOffColor    [UIColor colorWithRed:26/255.0 green: 27/255.0 blue: 29/255.0 alpha: 1.0]
#define kDefaultTrackContrastColor [UIColor colorWithRed:26/255.0 green: 27/255.0 blue: 29/255.0 alpha: 1.0]

//Thumb Colors
#define kDefaultThumbTintColor [UIColor colorWithRed:163/255.0 green: 163/255.0 blue: 163/255.0 alpha: 1]
#define kDefaultThumbBorderColor [UIColor colorWithRed:26/255.0 green: 27/255.0 blue: 29/255.0 alpha: 1.0]//[UIColor colorWithWhite: 0.9f alpha:1.0f]

//Appearance - Layout

//Size of knob with respect to the control - Must be a multiple of 2
#define kThumbOffset 2
#define kThumbTrackingGrowthRatio 1.0f                //Amount to grow the thumb on press down
...
- (void)drawRect:(CGRect)rect
{
    ...
    [_thumb setBackgroundColor: [UIColor colorWithRed:46/255.0 green:47/255.0 blue:51/255.0 alpha:1.0]];
    
    //Make the knob a circle and add a shadow
    CGFloat roundedCornerRadius = _thumb.frame.size.height/2.0f;
    [_thumb.layer setBorderWidth: 0.3];
    [_thumb.layer setBorderColor: [self.thumbBorderColor CGColor]];
    [_thumb.layer setCornerRadius: roundedCornerRadius];
    [_thumb.layer setShadowColor: [[UIColor colorWithRed:26/255.0 green: 27/255.0 blue: 29/255.0 alpha: 1.0] CGColor]];
    [_thumb.layer setShadowOffset: CGSizeMake(0, 0)];
