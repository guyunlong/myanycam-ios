...
typedef struct PacketQueue {
    AVPacketList *first_pkt, *last_pkt;//一串包 的链表
    int nb_packets;
    int size;
    int abort_request;
    SDL_mutex *mutex;
...
typedef struct VideoState {
    ...
    SDL_cond *subpq_cond;//原型类似pthread_cond_t.用于事件同步
    ...
    SDL_cond *continue_read_thread;//条件变量
} VideoState;
...
//播放器
@interface RTSPPlayViewController : BaseViewController {
    //显示视频的view
...
@property (retain, nonatomic) IBOutlet UILabel *playtipLabel;

@property (nonatomic, assign) VideoPlayState videoPlayState;
@property (retain, nonatomic) IBOutlet UIView *videoControlButton;
@property (retain, nonatomic) IBOutlet UINavigationBar *topBarNavigationbar;
@property (retain, nonatomic) IBOutlet UINavigationItem *topBarNavigationbarItem;
@property (retain, nonatomic) IBOutlet MYImageViewAnimation *playCircleImageView;
@property (retain, nonatomic) IBOutlet UIView *playBackView;
