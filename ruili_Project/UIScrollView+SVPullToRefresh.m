...
@property (nonatomic, retain) SVPullToRefreshArrow *arrow;
...
@property (nonatomic, assign,readwrite) CGFloat originalTopInset;
@property (nonatomic, assign,readwrite) CGFloat originalBottomInset;
