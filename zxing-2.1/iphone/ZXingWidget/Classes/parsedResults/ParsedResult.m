...
+ (UIImage *)icon {
  ...
  if (icon == nil) {
    ...
    NSString *s = NSStringFromClass([self class]);
      ...
      {
          stringSize = [s sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16.0f]}];
      }
    ...
    CGContextTranslateCTM(ctx, 
     ...
     if ( [[UIDevice currentDevice].systemVersion floatValue] < 7.0 ) {
         ...
         [s drawAtPoint:CGPointMake(0, 0) withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16.0f]}];
